<template>
  ...
  <q-page v-if="$midata.isLoggedIn()">
    ...
    <p>
      ...
      können sie hier ein paar Daten generieren lassen. Diese folgen einem
      Trend, sind aber sonst zufällig generiert. Vom ausgewählten Datum an,
      werden 48 zufällige Observationen generiert. Das Aktualisieren der Daten
      kann manchmal einige Sekunden länger dauern als angezeigt.
    </p>
    <p>
