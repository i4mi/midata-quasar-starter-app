export default {
  ...
  card: {
    title: 'Matterhorn: The Jewel of the Swiss Alps',
    subTitle: 'What hiking enthusiasts should know',
    ...
    more: 'More',
    info: 'Photo from Pixabay by Pexels',
  },
  interpolation: {
    message: 'The weather today is {condition}!',
    label: 'weather',
    weather: {
      sun: 'sunny',
      cloud: 'cloudy',
